...
| 指标 | 数量 | 占预检未过 | 占最终该专区 |
| :--- | ---: | ---: | ---: |
| 预检未过 → 家宽总订阅 | `5` | `0.23%` | `55.56%` |
| 预检未过 → 非家宽总订阅 | `4` | `0.18%` | `20.0%` |
| 预检未过 → 最终任一总订阅 | `9` | `0.41%` | - |

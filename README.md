...
| 指标 | 数量 | 占预检未过 | 占最终该专区 |
| :--- | ---: | ---: | ---: |
| 预检未过 → 家宽总订阅 | `2` | `0.14%` | `50.0%` |
| 预检未过 → 非家宽总订阅 | `1` | `0.07%` | `8.33%` |
| 预检未过 → 最终任一总订阅 | `3` | `0.22%` | - |

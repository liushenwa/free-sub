...
| 指标 | 数量 | 占预检未过 | 占最终该专区 |
| :--- | ---: | ---: | ---: |
| 预检未过 → 家宽总订阅 | `2` | `0.14%` | `66.67%` |
| 预检未过 → 非家宽总订阅 | `5` | `0.35%` | `26.32%` |
| 预检未过 → 最终任一总订阅 | `7` | `0.48%` | - |
